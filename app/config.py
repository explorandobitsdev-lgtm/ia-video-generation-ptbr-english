...
class Settings(BaseSettings):
    ...
    narration_gap_ms: int = 180
    dialogue_gap_ms: int = 120
    intra_sentence_gap_ms: int = 90
    sentence_gap_ms: int = 230
    tts_pt_length_scale: float = 1.04
    tts_en_length_scale: float = 1.03
